...
private:
    constexpr static const char* TAG = "HttpClientAsync";
private:
    ...
    public:
        ...
        Action onBody(const oatpp::String& body) {
            OATPP_LOGD(TAG, "[GetCoroutine. doGetAsync] data='%s'", body->c_str());
            return finish();
        }
    };
    ...
    public:
        ...
        Action onBody(const oatpp::String& body) {
            OATPP_LOGD(TAG, "[PostCoroutine. doPostAsync] data='%s'", body->c_str());
            return finish();
        }
    };
    ...
    public:
        ...
        Action onBody(const oatpp::String& body) {
            OATPP_LOGD(TAG, "[PutCoroutine. doPutAsync] data='%s'", body->c_str());
            return finish();
        }
    };
    ...
    public:
        ...
        Action onBody(const oatpp::String& body) {
            OATPP_LOGD(TAG, "[PatchCoroutine. doPatchAsync] data='%s'", body->c_str());
            return finish();
        }
    };
    ...
    public:
        ...
        Action onBody(const oatpp::String& body) {
            OATPP_LOGD(TAG, "[DeleteCoroutine. doDeleteAsync] data='%s'", body->c_str());
            return finish();
        }
    };
...
public:
    ...
    public:
        AsyncUtils(const std::shared_ptr<HttpApiClientAsync>& clientasync) :m_clientasync(clientasync) { 
...
private:
    ...
    void run() {
        try
        {
            ...
            HttpClientAsync::AsyncUtils asyncUtils(clientasync);
            asyncUtils.Get("","");
        }
